...
class EfficientMemoryLinearFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        ctx.save_for_backward(x_outlier_compressed, x_sub_outlier_compressed, scale, w, L, R)
    ...
    def backward(ctx, grad_output, grad_outlier, grad_L, grad_R, grad_scale):
        ...
        x_outlier_compressed, x_sub_outlier_compressed, scale, w, L, R = ctx.saved_tensors
